...
class LessonAdmin(admin.ModelAdmin):
    ...
    def images(self, lesson):
        if lesson:
            return mark_safe("<img src='/static/{img_url}' alt='{alt}' width='120' />"
...
class CourseAppAdminSite(admin.AdminSite):
    ...
    def course_stats(self, request):
        ...
        stats = Course.objects.annotate(lesson_count=Count('lessons')) \
